    ...
    <GridTextRight>
      <template v-slot:left>
        <picture>
          <source
            media="(max-width: 639px)"
            srcset="/images/home/mobile/beautiful-stories.jpg"
          />
          <source
            media="(max-width: 1023px)"
      ...
      <template v-slot:right>
        ...
        <nuxt-link to="/" class="text-sm uppercase flex gap-4 items-center"
          ...
          <img src="/images/shared/desktop/arrow.svg" class="max-h-[12px]"
        /></nuxt-link>
      </template>
    </GridTextRight>
    <GridTextLeft mobileReverse>
      ...
      <template v-slot:right>
        <picture>
          <source
            media="(max-width: 639px)"
            srcset="/images/home/mobile/designed-for-everyone.jpg"
          />
          <source
            media="(max-width: 1023px)"
