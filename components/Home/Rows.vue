<template>
			...
			<GridTextLeft classLeft="bg-black text-white" mobileReverse gradientBar>
				<template v-slot:left>
					...
					<nuxt-link to="/" class="text-sm uppercase flex gap-4 items-center"
						...
						<img src="/images/shared/desktop/arrow-white.svg" class="max-h-[12px]"
					/></nuxt-link>
				</template>
	...
	<div class="">
		<div class="mx-auto max-w-screen-2xl">
			<GridTextRight classRight="bg-white dark:bg-gray-400">
				<template v-slot:left>
					<picture>
						<source
							media="(min-width: 641px and max-width: 1024px)"
						...
						/>
						<source media="(min-width: 1025px)" srcset="/images/home/desktop/beautiful-stories.jpg" />
						<img
			...
			<GridTextLeft mobileReverse classLeft="bg-white dark:bg-gray-400">
				<template v-slot:left>
					<h2
						class="text-[32px] leading-[40px] md:text-[40px] md:leading-[48px] uppercase font-semibold tracking-wide"
					>
				...
				<template v-slot:right>
					<picture>
						...
						/>
						<source media="(min-width: 1025px)" srcset="/images/home/desktop/designed-for-everyone.jpg" />
						<img
