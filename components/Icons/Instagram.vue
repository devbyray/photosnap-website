...
<template>
  ...
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
      <defs>
        <linearGradient id="instagram" x1="0%" x2="100%" y1="100%" y2="0%">
          <stop offset="0%" :stop-color="hover ? '#FFC593' : '#fff'" />
          <stop offset="51.945%" :stop-color="hover ? '#BC7198' : '#fff'" />
          <stop offset="100%" :stop-color="hover ? '#5A77FF' : '#fff'" />
        </linearGradient>
      </defs>
      <path
        fill="url(#instagram)"
